...
Shortcuts (`/scout`, `/recall`, `/next`, `/idea`, `/memory`, `/research`, `/build`) still work for
those who know what they want. `/idea-gate` is for "just take my input and figure it out."
...
| `research` | analyze a source (URL/PDF/YouTube) deeply | Mira → Nova-V (notebooklm-py, gated) |
